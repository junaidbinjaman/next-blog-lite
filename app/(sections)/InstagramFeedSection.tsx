...
function InstagramFeedSection() {
    return (
        <section className='mb-15'>
            ...
            <div className='flex items-center justify-center mx-auto gap-x-4 mt-7.5'>
                <Image
                    src='/images/instagram-images/instagram-image-1.jpg'
                    className='rounded-lg w-38.75 h-38.75 hover:rotate-12 hover:scale-90 transition-all duration-300 ease-in-out'
                    width={155}
                    height={155}
